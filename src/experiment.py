...
digits = datasets.load_digits(n_class=N_CLASS)
 ...
 # %%
# THE EXPERIMENT LOOP
mean_accuracies_classic = []
std_accuracies_classic = []
mean_f1s_classic = []
std_f1s_classic = []
mean_times_classic = []

mean_accuracies_quantum = []
std_accuracies_quantum = []
mean_f1s_quantum = []
std_f1s_quantum = []
mean_times_quantum = []

for size in TRAINING_SIZES:
    trial_accuracies_classic = []
    trial_f1s_classic = []
    trial_times_classic = []
    
    trial_accuracies_quantum = []
    trial_f1s_quantum = []
    trial_times_quantum = []
    
    X_train, X_test, y_train, y_test = train_test_split(
        digits.data, digits.target, train_size=size, random_state=22
    )
    ...
    print(f"Calculating Training Kernel Matrix (Simulating Quantum Circuit) on Training Size: {size}")
